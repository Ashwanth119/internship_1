...
let fun_unknown:unknown=function add(x:number=20,y:number=30){
    console.log(x+y);
}
...
function fun_void(name:string):void{
...
function fun_never_error(name:string):never{
...
// 1. sum()
function sum(param1?:number,param2:number=200){
    if(param1)
...
// 2. mul()
function mul(param1?:number,param2:number=200){
    if(param1!==undefined)
        console.log(param1*param2);
    else
        console.log(param2);
...
let var_or_1:string|number|boolean;
var_or_1="String";
var_or_1=10;
var_or_1=true;